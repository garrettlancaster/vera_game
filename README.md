...
| `game.js`    | The whole game: world gen, physics, mobs, inventory, rendering |
| `sounds.js`  | Procedural Web Audio sound engine (no audio files needed) |
...
- No build step, no dependencies to install — it's just these four files.
